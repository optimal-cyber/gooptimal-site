...
The bottleneck was never the controls. It was never the framework, a point the Pentagon has now conceded by replacing the framework outright. It was the gap between how we build systems and how we prove they are secure. Close that gap, and the ATO becomes what it was always meant to be: a risk decision, not a paperwork exercise.
